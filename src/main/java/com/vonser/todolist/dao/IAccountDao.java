...
public interface IAccountDao {
     ...
     * @see com.vonser.todolist.controllers.SignupController
     * @see com.vonser.todolist.controllers.api.AccountsController
     * @see com.vonser.todolist.controllers.api.TasksController with update(update method in the account service uses this method)
     * **/
    void add(Account account);

    /**
     * is for making sure that the passed username and password are existing in the accounts table in the database
     * @see com.vonser.todolist.controllers.LoginController
     * **/
     ...
     * @see com.vonser.todolist.service.AccountService
     * **/
